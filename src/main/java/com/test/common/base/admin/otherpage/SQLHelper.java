...
public class SQLHelper {
	 ...
	 */
	public static int getCount(final String sql, final Connection connection, final MappedStatement mappedStatement, final Object parameterObject, final BoundSql boundSql, Log log)
			throws SQLException {
	...
	public static String generatePageSql(String sql, Page<Object> page) {
		...
		return getLimitString(sql, page.getFirstResult(), page.getMaxResults());
	...
	/**
	    ...
	    * @return 包含占位符的分页sql
	    */
	private static String getLimitString(String sql, int offset, String offsetPlaceholder, String limitPlaceholder) {
