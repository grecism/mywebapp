package com.test.controller.system.user;
...
import util.admin.FileDownload;
import util.admin.FileUpload;
import util.admin.GetPinyin;
import com.test.common.base.admin.shiro.Jurisdiction;
import util.admin.ObjectExcelRead;
import util.admin.PageData;
import util.admin.ObjectExcelView;
...
public class UserController extends BaseController {
	...
	public void deleteU(PrintWriter out) throws Exception{
		...
		try {
			...
			LOG.save(Jurisdiction.getUsername(), "删除系统用户："+pd);
		} catch (Throwable e) {
			logger.error(e.toString(),e);
		}
		out.write("success");
	...
	public ModelAndView saveU() throws Exception{
		...
		try {
			if(null == userService.findByUsername(pd)){	//判断用户名是否存在
				...
				LOG.save(Jurisdiction.getUsername(), "新增系统用户："+pd.getString("USERNAME"));
	...
	public ModelAndView editU() throws Exception{
		...
		try {
			...
			LOG.save(Jurisdiction.getUsername(), "修改系统用户："+pd.getString("USERNAME"));
			mv.addObject("msg","success");
			mv.setViewName("save_result");
		} catch(Throwable e){
			logger.error(e.toString(), e);
	...
	public Object deleteAllU() throws Exception {
		...
		try {
			LOG.save(Jurisdiction.getUsername(), "批量删除user");
			pd = this.getPageData();
	...
	public ModelAndView exportExcel() throws Exception{
		...
		pd = this.getPageData();
		try{
			LOG.save(Jurisdiction.getUsername(), "导出用户信息到EXCEL");
	...
	public ModelAndView readExcel(
		...
		ModelAndView mv = this.getModelAndView();
		try {
			LOG.save(Jurisdiction.getUsername(), "从EXCEL导入到数据库");
			PageData pd = new PageData();
