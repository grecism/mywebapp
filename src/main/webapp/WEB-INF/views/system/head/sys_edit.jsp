						 ...
						 <div class="span6">
							<div class="tabbable">
						            <ul class="nav nav-tabs" id="myTab">
						              ...
						              <!-- <li><a data-toggle="tab" href="#profile3"><i class="green icon-cog bigger-110"></i>配置 NO2</a></li> -->
						              <li><a data-toggle="tab" href="#profile4"><i class="green icon-cog bigger-110"></i>配置 NO2</a></li>
						            </ul>
